...
int main(int argc, char **argv)
{
    ...
    if (!t_wav.is_empty()) {
        ...
        auto t_conv_1 = conv2d(t_max_pool, 64, 3, t_weights_kernel, t_weights_bias, relu<float>);
        t_max_pool.free();
        ...
        auto t_conv_2 = conv2d(t_max_pool_1, 128, 3, t_weights_kernel, t_weights_bias, relu<float>);
        t_max_pool_1.free();
